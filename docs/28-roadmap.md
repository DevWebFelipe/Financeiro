...
Bloco B9 — Despesas (Expenses) — **implementado** (`/expenses` lazy-loaded, paginação e filtros oficiais, CRUD + pagamento/cancelamento/estorno conforme contrato, sem cartão na criação). Sem B10.
