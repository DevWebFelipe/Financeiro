...
public record RenegotiateAgreementRequest(
    ...
    @NotNull(message = "O valor líquido dos futuros é obrigatório.")
        @DecimalMin(
            value = "0.00",
            inclusive = true,
            message = "O valor líquido dos futuros não pode ser negativo.")
        @Digits(
            integer = 17,
            fraction = 2,
            message =
                "O valor líquido dos futuros deve ter no máximo 17 dígitos inteiros e 2"
                    + " decimais.")
        BigDecimal anticipatedFuturesNetAmount) {}
